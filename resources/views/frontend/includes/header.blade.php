    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand main-logo" href="{{route('homepage')}}"><img
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <form class="w-100 search-sec d-none position-relative">
                        <input id="search_input" type="search" class="form-control w-75 ms-auto py-2 search-box"
                               placeholder="search here...">
                        <div class="search-menu d-none w-75 end-0 position-absolute top-100">
                            <ul class="list-group" id="append_search_results">
