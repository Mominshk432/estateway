                                            ...
                                            <select name="status" id="" class="form-control">
                                                ...
                                                @if(count($statuses) > 0)
                                                    @foreach($statuses as $status)
                                                        <option {{$project->status == $status->id ? 'selected' : ''}}
                                                ...
                                                <div id="more_specifications">
                                                    @if(count($project->custom_specs) > 0)
                                                        @foreach($project->custom_specs as $customSpec)
                                                            @php
                                                                $customSpecCount = count($project->custom_specs);
                                                            @endphp

                                                            <div class="mb-3 d-flex align-items-center gap-2">
                                                                <div>
                                                                    <img onclick="$(this).next().click()"
                                                                         id="more_specs-icon-{{$loop->index}}"
                                                                         ...
                                                                         alt="">
                                                                    <input
                                                                        onchange="showSelectedImage($(this),'more_specs-icon-{{$loop->index}}');$(this).next().remove()"
                                                                        type="file" class="d-none"
                                                                        name="more_specs_icon[]">
                                                                    <input value="{{$customSpec->icon ?? ''}}"
                                                                           type="text" class="d-none"
                                                                           name="old_more_specs_icon[]">
                                                                </div>
                                                                <div class="w-100">
                                                                    <input value="{{$customSpec->title ?? ''}}"
                                                                           type="text" name="more_specs_title[]"
                                                                           placeholder="Title..."
                                                                           class="form-control mb-2">
                                                                    <input value="{{$customSpec->value ?? ''}}"
                                                                           type="text" name="more_specs_value[]"
                                                                           placeholder="Value..."
                                                                           class="form-control">
                                                                </div>
                                                                <button type="button"
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{$project->seo_title ?? ''}}"
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" value="{{$project->seo_keywords ?? ''}}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea autocomplete="off" placeholder="Seo Description"
                                                      ...
                                                      rows="05">{{$project->seo_description ?? ''}}</textarea>
                                        </div>
                                    </div>
                                </div>
...
@section('custom-scripts')
    <script>
        ...
        var moreSpecsCount = '{{$customSpecCount}}';
