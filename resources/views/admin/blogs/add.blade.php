                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input autocomplete="off" placeholder="Title..." type="text"
                                                   id="simpleinput"
                                                   name="title" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Short Description</label>
                                            <input autocomplete="off" placeholder="Short Description..." type="text"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input autocomplete="off" placeholder="Seo Title..." type="text"
                                                           id="simpleinput"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input autocomplete="off" placeholder="Seo Keywords" type="text"
                                                           id="seo_tags"
